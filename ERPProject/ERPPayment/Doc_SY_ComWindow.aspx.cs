...
{
    public partial class Doc_SY_ComWindow : PageBase
    {
        ...
        {
            string sql = "SELECT SEQNO,GDSEQ,GDNAME,BARCODE,BZSL,JXTAX,HSJJ,HSJE,ZPBH,HWID,PZWH,RQ_SC,MEMO,F_GETUNITNAME(UNIT) UNITNAME,F_GETPRODUCERNAME(PRODUCER) PRODUCERNAME,GDSPEC FROM DAT_CK_COM WHERE SEQNO ='{0}' ";
