<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Settlement.aspx.cs" Inherits="ERPProject.ERPPayment.Settlement" %>
...
<body>
                                    ...
                                    <Items>
                                        ...
                                        <f:Button ID="btnTemplate" runat="server" Text="打印单据" Icon="Printer" EnableDefaultState="false">
                                            <Menu ID="Menu1" runat="server">
                                                <f:MenuButton ID="btnPrintPH" Icon="Printer" Text="打印普耗结算单" runat="server" OnClick="btnPrint_Click" DisableControlBeforePostBack="false">
                                                </f:MenuButton>
                                                <f:MenuButton ID="btnPrintPJ" Icon="Printer" Text="打印配件结算单" runat="server" OnClick="btnPrint_Click" DisableControlBeforePostBack="false">
                                                </f:MenuButton>
                                            </Menu>
                                        </f:Button>
                                        <f:ToolbarSeparator runat="server" />
                    ...
                    <Items>
                        <f:Panel ID="Panel1" runat="server" ShowBorder="false" BodyPadding="0px" Layout="VBox"
                            ...
                            <Items>
                                ...
                                <f:Grid ID="GridGoods" BoxFlex="1" ShowBorder="false" ShowHeader="false" EnableTextSelection="true"
    ...
    <script type="text/javascript">
        function PrintJSDBill(flag) {
            ...
            if (flag == "pj") {
                ReportViewer.ReportURL = "/ERPXM/XJ_CJRM/GRF/jsmxd_wxpj.grf?timestamp=" + new Date().getTime();
            } else {
