<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doc_RK_ComWindow.aspx.cs" Inherits="ERPProject.ERPQuery.Doc_RK_ComWindow" %>
            ...
            <Items>
                ...
                <f:Grid ID="GridGoods" AnchorValue="100% -30" ShowBorder="true" ShowHeader="false" EnableSummary="true" SummaryPosition="Bottom" OnRowDataBound="GridGoods_RowDataBound"
                    ...
                    <Columns>
                        ...
                        <f:BoundField Width="170px" DataField="PRODUCERNAME" HeaderText="生产厂家" TextAlign="Center" Hidden="true" />
