<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doc_CX_ComWindow.aspx.cs" Inherits="ERPProject.ERPQuery.Doc_CX_ComWindow" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="True" BodyPadding="0px" Layout="Anchor"
            ...
            <Items>
                ...
                <f:Grid ID="GridGoods" AnchorValue="100% -30" ShowBorder="true" ShowHeader="false" EnableSummary="true" SummaryPosition="Bottom" OnRowDataBound="GridGoods_RowDataBound"  EnableColumnLines="true"
                    AllowSorting="false" AutoScroll="true" runat="server" DataKeyNames="SUPID" PageSize="30" AllowPaging="true" OnPageIndexChange="GridGoods_PageIndexChange">
                    <Columns>
                        ...
                        <f:BoundField Width="70px" DataField="SL" ColumnID="SL" HeaderText="数量" TextAlign="Right" />
