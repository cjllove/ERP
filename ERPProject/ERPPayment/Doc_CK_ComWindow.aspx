<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doc_CK_ComWindow.aspx.cs" Inherits="ERPProject.ERPQuery.Doc_CK_ComWindow" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="True" BodyPadding="0px" Layout="Anchor"
            ...
            <Items>
                ...
                <f:Grid ID="GridGoods" AnchorValue="100% -30" ShowBorder="true" ShowHeader="false" EnableSummary="true" SummaryPosition="Bottom" OnRowDataBound="GridGoods_RowDataBound"
                    AllowSorting="false" AutoScroll="true" runat="server" DataKeyNames="SEQNO" PageSize="30" AllowPaging="true" OnPageIndexChange="GridGoods_PageIndexChange">
                    <Columns>
                        ...
                        <f:BoundField Width="70px" DataField="BZSL" ColumnID="SL" HeaderText="数量" TextAlign="Right" />
                        ...
                        <f:BoundField Width="70px" DataField="UNITNAME" ColumnID="UNITNAME" HeaderText="包装单位" TextAlign="Center" />
                        <f:BoundField Width="70px" DataField="GDSPEC" ColumnID="GDSPEC" HeaderText="商品规格" TextAlign="Center" />
                        <f:BoundField Width="70px" DataField="ISDG" HeaderText="是否代管" TextAlign="Center"  Hidden="true" />
        ...
        <f:HiddenField ID="type" runat="server"></f:HiddenField>
    </form>
</body>
</html>
