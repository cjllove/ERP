<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderUpload3.aspx.cs" Inherits="ERPProject.ERPUpload.OrderUpload3" %>
                    ...
                    <Items>
                        <f:Panel ID="Panel2" runat="server" ShowBorder="false" BodyPadding="0px" Layout="VBOX"
                            ...
                            <Items>
                                ...
                                <f:Grid ID="GridList" BoxFlex="1" AnchorValue="100% -195" ShowBorder="false" ShowHeader="false" EnableColumnLines="true"
                                    AllowSorting="false" AutoScroll="true" runat="server" CssStyle="border-top: 1px solid #99bce8;"
                                    DataKeyNames="SEQNO">
                                    <Columns>
