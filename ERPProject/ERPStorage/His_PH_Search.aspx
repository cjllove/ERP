<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="His_PH_Search.aspx.cs" Inherits="ERPProject.ERPStorage.His_PH_Search" %>
			...
			<Items> <f:Panel ID="Panel3" ShowBorder="false" BodyPadding="0px"
                 ...
                 <Toolbars>
                     ...
                     <f:ToolbarText runat="server" Text="注：【手动同步】同步HIS计费信息【手动计费】处理HIS计费【手动退费】处理HIS退费"></f:ToolbarText>
                                   ...
                                   <f:Button ID="btnINIT" EnablePostBack="false" Icon="BookOpen"  EnableDefaultState="false" runat="server" Text="同步HIS资料">
                                                    <Menu ID="Menu1" runat="server">
                                                        ...
                                                        <f:MenuButton ID="btnInitUser" Icon="TableAdd" EnablePostBack="true" OnClick="btnInitUser_Click" runat="server" Hidden="true"  Text="人员">
                                                          ...
                                                          <f:MenuButton ID="btnInitDept" Icon="TableAdd" EnablePostBack="true" OnClick="btnInitDept_Click" runat="server"  Text="部门">
                                                            ...
                                                            <f:MenuButton ID="btnInitCatid" Icon="TableAdd" EnablePostBack="true" OnClick="btnInitCatid_Click" runat="server"  Text="类别" Hidden="true">
                                                        </f:MenuButton>
                                                    </Menu>
                                                </f:Button>
