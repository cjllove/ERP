<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HighGoodsOrder.aspx.cs" Inherits="ERP3PRO.ERPStorage.HighGoodsOrder" %>
...
<body>
    ...
    <form id="form1" runat="server">
                    ...
                    <Items>
                        <f:Panel ID="Panel2" runat="server" ShowBorder="false" BodyPadding="0px" Layout="Anchor"
                            ...
                            <Items>
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar2" runat="server">
                                            <Items>
                                                ...
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button ID="bntSearch" Icon="Magnifier" Text="查 询" ValidateForms="Formlist" EnableDefaultState="false" EnablePostBack="true" runat="server" OnClick="btnBill_Click" />
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Items>
                                        <f:Form ID="Formlist" ShowBorder="false" AutoScroll="false" BodyPadding="10px 10px 5px 10px"
                                            ...
                                            <Rows>
                                                <f:FormRow>
                                                    <Items>
                                                        <f:TriggerBox ID="tgbBILLNO" runat="server" Label="单据编号" MaxLength="15" EmptyText="单据编号" ShowTrigger="false" OnTriggerClick="tgbBILLNO_TriggerClick" />
                                                ...
                                                <f:FormRow ColumnWidths="25% 25% 25% 25%">
                                                    <Items>
                                                        ...
                                                        <f:TriggerBox ID="tgbGDINFO" runat="server" Label="商品信息" EmptyText="商品信息，可模糊查询" ShowTrigger="false" OnTriggerClick="tgbBILLNO_TriggerClick" />
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -108" ShowBorder="false" ShowHeader="false" EnableColumnLines="true" OnRowDataBound="GridList_RowDataBound"
                                    AllowPaging="true" IsDatabasePaging="true" OnPageIndexChange="GridList_PageIndexChange" PageSize="70"
                                    ...
                                    EnableHeaderMenu="true" SortField="SEQNO" SortDirection="ASC" AllowSorting="true" OnSort="GridList_Sort" EnableMultiSelect="true" KeepCurrentSelection="true"
                                    EnableSummary="true" SummaryPosition="Bottom">
                                    <Columns>
                                        <f:RowNumberField Width="35px" TextAlign="Center" HeaderText="序号" EnablePagingNumber="true" />
                                        ...
                                        <f:BoundField Width="120px" DataField="DEPTID" ColumnID="DEPTID" HeaderText="订货科室" SortField="DEPTID" TextAlign="Center" />
                                        <f:BoundField Width="90px" DataField="SUBSUM" ColumnID="SUBSUM" HeaderText="订货金额" SortField="SUBSUM" TextAlign="Right" DataFormatString="{0:F2}" />
                                        <f:BoundField Width="70px" DataField="SUBNUM" ColumnID="SUBNUM" HeaderText="明细条数" SortField="SUBNUM" TextAlign="Center" />
                                        <f:BoundField Width="80px" DataField="CGY" HeaderText="业务员" SortField="CGY" TextAlign="Center" />
                                        ...
                                        <f:BoundField Width="80px" DataField="SHR" HeaderText="审核员" SortField="SHR" TextAlign="Center" />
                                        <f:BoundField Width="90px" DataField="SHRQ" HeaderText="审核日期" TextAlign="Center" SortField="SHRQ" DataFormatString="{0:yyyy-MM-dd}" />
                                        <f:BoundField MinWidth="120px" ExpandUnusedSpace="true" DataField="MEMO" HeaderText="备注" SortField="MEMO" TextAlign="Center" />
                                    </Columns>
                                </f:Grid>
                            </Items>
                        </f:Panel>
                    ...
                    <Items>
                        <f:Panel ID="Panel1" runat="server" ShowBorder="false" BodyPadding="0px" Layout="Region"
                            ...
                            <Items>
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                ...
                                                <f:Button ID="btnCommit" Icon="Disk" Text="提 交" EnableDefaultState="false" EnablePostBack="true" runat="server" ValidateForms="FormDoc" />
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button ID="btnAudit" Icon="UserTick" Text="审 核" EnableDefaultState="false" EnablePostBack="true" ConfirmText="是否确认保存并审核此单据?" runat="server" OnClick="btnBill_Click" />
                                        ...
                                        <f:Form ID="FormDoc" ShowBorder="false" AutoScroll="false" BodyPadding="10px 10px 5px 10px"
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow>
                                                    <Items>
                                                        <f:DropDownList ID="docSTR2" runat="server" Label="订货类型">
                                                            <f:ListItem Text="备货" Value="BH" Selected="true" />
                                                ...
                                                <f:FormRow ColumnWidths="50% 25% 25%">
                                                    <Items>
                                                        <f:TextBox ID="tbxMEMO" runat="server" Label="备注" MaxLength="80" EmptyText="填写备注信息" />
                                ...
                                <f:Grid ID="GridCom" AnchorValue="100% -146" ShowBorder="false" ShowHeader="false" EnableColumnLines="true" OnAfterEdit="GridCom_AfterEdit"
                                    AllowSorting="false" AutoScroll="true" runat="server" CssStyle="border-top: 1px solid #99bce8;" EnableRowSelectEvent="true"
                                    DataKeyNames="GDSEQ,SUPID" AllowCellEditing="true" ClicksToEdit="1" EnableAfterEditEvent="false"
                                    ...
                                    <Columns>
                                        ...
                                        <f:RenderField Width="110px" DataField="GDSEQ" ColumnID="GDSEQ" HeaderText="商品编码" FieldType="String" EnableHeaderMenu="false" EnableLock="true" Locked="true">
                                            <Editor>
                                        ...
                                        <f:RenderField Width="70px" ColumnID="UNITNAME" DataField="UNITNAME" FieldType="String" HeaderText="订货单位" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="comUNITNAME" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="70px" DataField="BZHL" ColumnID="BZHL" HeaderText="包装含量" TextAlign="Center" EnableColumnHide="false" EnableHeaderMenu="false">
                                            <Editor>
                                        ...
                                        <f:RenderField Width="70px" DataField="BZSL" ColumnID="BZSL" HeaderText="订货数<font color='red'>*</font>" TextAlign="Center" FieldType="Auto">
                                            <Editor>
                                                <f:NumberBox ID="comBZSL" CssClass="ColBlue" Required="true" runat="server" MinValue="0" NoDecimal="true" MaxValue="99999999" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="90px" DataField="HSJJ" ColumnID="HSJJ" HeaderText="含税进价" TextAlign="Right" FieldType="Double" RendererFunction="round4">
                                            <Editor>
                                                <f:Label ID="comHSJJ" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="90px" DataField="HSJE" ColumnID="HSJE" HeaderText="含税金额" TextAlign="Right" FieldType="Auto" RendererFunction="round2">
                                            <Editor>
                                                <f:Label ID="comHSJE" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="170px" DataField="SUPNAME" ColumnID="SUPNAME" HeaderText="供应商<font color='red'>*</font>" EnableColumnHide="false" EnableHeaderMenu="false">
                                            <Editor>
                                        ...
                                        <f:RenderField MinWidth="120px" ExpandUnusedSpace="true" DataField="MEMO" ColumnID="MEMO" HeaderText="备注" TextAlign="Center">
                                            <Editor>
        ...
        <f:Window ID="WinAuto" Title="自动订货信息" Hidden="true" EnableIFrame="false" runat="server" ShowHeader="false" ShowBorder="false"
                ...
                <f:Panel ID="Panel5" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
                    <Items>
                        <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Center" RegionSplit="false" EnableCollapse="false" CssStyle="border-bottom: 0px solid #99bce8;"
                            Width="400px" Title="自动订货" ShowBorder="true" ShowHeader="true">
                            <Items>
                                <f:Form ID="Form3" ShowBorder="false" AutoScroll="false" BodyPadding="5px 10px"
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:RadioButtonList ID="rblTYPE" runat="server" AutoPostBack="true" OnSelectedIndexChanged="rblTYPE_SelectedIndexChanged">
                                                    ...
                                                    <f:RadioItem Text="部门定数生成" Value="DS" />
                                                </f:RadioButtonList>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                                <f:DropDownList runat="server" ID="ddlDeptOrder" Label="入库库房" ShowRedStar="true" Required="true"></f:DropDownList>
                                            </Items>
                                        </f:FormRow>
                                        <f:FormRow>
                                            <Items>
                                    ...
                                    <Rows>
                                        ...
                                        <f:FormRow>
                                            <Items>
                                                <f:Label ID="memo" runat="server" Text="订货量 =（备货天数+订货周期)*日均用量 -库房库存-在途库存"></f:Label>
                                            </Items>
                                        </f:FormRow>
                                    </Rows>
                                </f:Form>
                        ...
                        <f:Panel runat="server" ID="panel6" OnExpand="panel6_Expand" EnableExpandEvent="true" Collapsed="true" AutoScroll="true" Width="200px" RegionPosition="Right" RegionSplit="false" EnableCollapse="true" Title="高级设置" ShowBorder="false" CssStyle="border-top: 1px solid #99bce8;border-right: 1px solid #99bce8;" ShowHeader="true">
                            <Items>
                                <f:Grid ID="grdDept" ShowBorder="false" ShowHeader="false" ShowGridHeader="true" EnableCheckBoxSelect="true" EnableMultiSelect="true" KeepCurrentSelection="true"
                                    AutoScroll="true" runat="server" DataKeyNames="CODE" EnableColumnLines="true" AllowSorting="true" EnableHeaderMenu="true">
                                    <Columns>
                                        <f:RowNumberField Width="30px" TextAlign="Center" EnablePagingNumber="true" HeaderText="NO" />
                                        <f:BoundField Hidden="true" DataField="CODE" SortField="CODE" HeaderText="科室" TextAlign="Center" />
                                        <f:BoundField Width="110px" DataField="NAME" SortField="NAME" HeaderText="科室" TextAlign="Center" />
                                    </Columns>
                                </f:Grid>
                            </Items>
                        </f:Panel>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar7" runat="server" Position="Bottom" ToolbarAlign="Right">
                    <Items>
                        ...
                        <f:Button ID="btn_Close" Text="关闭" EnableDefaultState="false" Icon="SystemClose" runat="server" OnClick="btn_Close_Click"></f:Button>
                    </Items>
                </f:Toolbar>
            </Toolbars>
        </f:Window>
    ...
    <script type="text/javascript">
        ...
        function DownLoadModelclick() {
            window.location.href = '计划导入模板.xlsx';
        }
        function btnPrint_onclick() {
            ...
            ReportViewer.ReportURL = "/grf/HighGoodsOder.grf?time=" + new Date().getTime();
            var dataurl = "/captcha/PrintReport.aspx?Method=HighGoodsOder&osid=" + billNo;
        ...
        function OnGridDataChange(event)
        {
            console.log("11111");
        }
