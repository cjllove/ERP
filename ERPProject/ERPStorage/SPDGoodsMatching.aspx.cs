...
{
    public partial class ERPGoodsMatching : BillBase
    {
        ...
        {
            string Sql = @"SELECT C.NAME 医院名称,A.HISCODE HIS编码,A.HISNAME 商品名称,B.GDSPEC 规格,D.NAME 单位,B.HSJJ 价格,E.name 生产厂家,B.PIZNO 注册证号,B.GDSEQ ERP编码,B.BAR3 ERP编码,
