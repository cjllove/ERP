<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderUpload4.aspx.cs" Inherits="ERPProject.ERPUpload.OrderUpload4" %>
                    ...
                    <Items>
                        <f:Panel ID="Panel5" runat="server" ShowBorder="false" BodyPadding="0px" Layout="VBOX"
                            ...
                            <Items>
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar3" runat="server" Position="Bottom">
                                            <Items>
                                                ...
                                                <f:Button ID="btnDH" Icon="PageExcel" ConfirmText="是否导出订货信息?" Text="Excel订货导出" runat="server" OnClick="btnDH_Click" EnableDefaultState="false">
                                                </f:Button>
                                                <f:Button ID="btnDS" Icon="PageExcel" ConfirmText="是否导出科室定数信息?" Text="Excel定数导出" runat="server" OnClick="btnDS_Click" EnableDefaultState="false">
                                                </f:Button>
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                                    ...
                                                    <Rows>
                                                        <f:FormRow ColumnWidths="70% 14% 13%">
                                                            <Items>
                                                                ...
                                                                <f:Button ID="ExlIn" CssStyle="margin-left:30px" Icon="PageBreakInsert" runat="server" Text="Excel导入系统" OnClick="ExlIn_Click" EnableDefaultState="false"></f:Button>
                                                                <f:Button ID="ErrSrch" runat="server" Icon="PageExcel" Text="Excel错误信息" OnClick="ErrSrch_Click" EnableDefaultState="false"></f:Button>
                                                            </Items>
                                                        </f:FormRow>
                                                    </Rows>
                                                </f:Form>
                                ...
                                <f:Grid ID="GridIns" BoxFlex="1" AnchorValue="100% -168" ShowBorder="false" ShowHeader="false" EnableColumnLines="true"
                                ...
                                <f:Grid ID="GridDs" BoxFlex="1" AnchorValue="100% -95" ShowBorder="false" ShowHeader="false" EnableColumnLines="true"
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar5" runat="server">
                                            <Items>
                                                <f:ToolbarText ID="ToolbarText5" CssStyle="" Text="计算公式：(科室库存下限=定数量*库存下限基数)(科室库存上限=定数量*库存上限基数)" runat="server" />
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Columns>
