<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderUpload1.aspx.cs" Inherits="ERPProject.ERPUpload.OrderUpload1" %>
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" TabPosition="Right" EnableTabCloseMenu="false" ActiveTabIndex="0" runat="server">
            <Tabs>
                <f:Tab Title="原始数据分析" Icon="Table" Layout="Fit" runat="server">
                    <Items>
                        <f:Panel ID="Panel5" runat="server" ShowBorder="false" BodyPadding="0px" Layout="VBOX" ShowHeader="false">
                            <Items>
                                <f:Panel ID="Panel6" ShowBorder="false" BodyPadding="0px" Layout="Anchor" ShowHeader="False" runat="server">
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar3" runat="server" Position="Bottom" Hidden="true">
                                            <Items>
                                                <f:ToolbarText ID="ToolbarText3" CssStyle="" Text="操作信息：(定数数量=日均用量*科室送货周期(未定义则默认7日)/出库单位含量)(定数含量=出库单位含量)" runat="server" />
                                                <f:ToolbarFill runat="server"></f:ToolbarFill>
                                                <f:Button ID="btnRecy" Icon="ArrowRotateClockwise" Text="重置计算数据" ConfirmText="是否重新计算导入数据?" EnablePostBack="true" runat="server" OnClick="btnRecy_Click" />
                                                <f:Button ID="bunClear" Icon="Erase" Text="清空记录" ConfirmText="是否清空导入数据?" EnablePostBack="true" runat="server" OnClick="bunClear_Click" />
                                                <f:ToolbarSeparator runat="server"></f:ToolbarSeparator>
                                                <f:Button ID="btnDH" Icon="PageExcel" ConfirmText="是否导出订货信息?" Text="Excel订货导出" runat="server" OnClick="btnDH_Click">
                                                </f:Button>
                                                <f:Button ID="btnDS" Icon="PageExcel" ConfirmText="是否导出科室定数信息?" Text="Excel定数导出" runat="server" OnClick="btnDS_Click">
                                                </f:Button>
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Items>
                                        <f:GroupPanel runat="server" Title="医院匹配信息导入">
                                            <Items>
                                                <f:Form ID="Form3" ShowBorder="false" AutoScroll="false" BodyPadding="10px 10px 5px 10px" ShowHeader="False" LabelWidth="90px" runat="server">
                                                    <Rows>
                                                        <f:FormRow ColumnWidths="36% 11% 3% 7% 9% 9% 10% 6%">
                                                            <Items>
                                                                <f:FileUpload runat="server" ID="fpdExcelJC" Label="选择Excel"  EmptyText="请选择已经匹配信息,已匹配则不需要导入" ShowRedStar="true"></f:FileUpload>
                                                                <f:CheckBox runat="server" ID="CbxAll" CssStyle="margin-left:20px" Label="强制导入" ShowRedStar="true" ></f:CheckBox>
                                                                <f:Label runat="server"></f:Label>
                                                                <f:Button ID="btnJCXX" Icon="PageBreakInsert" runat="server" Text="Excel导入" OnClick="btnJCXX_Click"  EnableDefaultState="false"></f:Button>
                                                                <f:Button ID="BtnGoodsErr" runat="server" Icon="SystemSearch" Text="Excel错误查询" OnClick="BtnGoodsErr_Click" EnableDefaultState="false"></f:Button>
                                                                <f:Button ID="btnGoodsSed" runat="server" Text="Excel信息查询" EnablePostBack="true" Icon="SystemSearch" OnClick="btnGoodsSed_Click" EnableDefaultState="false"></f:Button>
                                                                <f:Button ID="btnInssys" runat="server" CssStyle="margin-left:40px" Icon="PackageStart" ConfirmText="是否确定将数据更新至系统中?" Text="导入系统" OnClick="btnInssys_Click" EnableDefaultState="false"></f:Button>
                                                                <f:Button ID="btnExp" runat="server" Icon="DiskDownload" Text="样表下载" ConfirmText="是否下载空白匹配信息样表?" OnClick="btnExp_Click" EnableDefaultState="false"></f:Button>
                                                            </Items>
                                                        </f:FormRow>
                                                    </Rows>
                                                </f:Form>
                                    ...
                                    <Items>
                                        <f:GroupPanel runat="server" Title="医院销售信息导入" Hidden="true">
                                            <Items>
                                                <f:Form ID="Form2" ShowBorder="false" AutoScroll="false" BodyPadding="10px 10px 5px 10px" ShowHeader="False" LabelWidth="90px" runat="server">
                                                    <Rows>
                                                        <f:FormRow ColumnWidths="70% 14% 13%">
                                                            <Items>
                                                                <f:FileUpload runat="server" ID="fueExl" Label="选择Excel" EmptyText="请选择需要进行数据分析的Excel原始表格" ShowRedStar="true"></f:FileUpload>
                                                                <f:Button ID="ExlIn" CssStyle="margin-left:30px" Icon="PageBreakInsert" runat="server" Text="Excel导入系统" OnClick="ExlIn_Click"></f:Button>
                                                                <f:Button ID="ErrSrch" runat="server" Icon="PageExcel" Text="Excel错误信息" OnClick="ErrSrch_Click"></f:Button>
                                                            </Items>
                                                        </f:FormRow>
                                                    </Rows>
                                                </f:Form>
                                ...
                                <f:Grid ID="GridIns" BoxFlex="1" AnchorValue="100% -70" ShowBorder="false" ShowHeader="false" EnableColumnLines="true"
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar4" runat="server" Hidden="true">
                                            <Items>
                                                ...
                                                <f:TriggerBox ID="trbSearch" LabelWidth="60px" Width="350px" MaxLength="20" Label="商品信息" runat="server" EmptyText="可输入ERP编码或ERP编码或商品名称" TriggerIcon="Search" OnTriggerClick="trbSearch_TriggerClick" />
                                                <f:Button ID="btnSrchDh" Icon="SystemSearch" CssStyle="margin-left:50px" Text="订货查询" EnablePostBack="true" runat="server" OnClick="btnSrchDh_Click" />
                                                <f:Button ID="btnSrchDs" Icon="SystemSearch" Text="定数查询" DisableControlBeforePostBack="false" runat="server" OnClick="btnSrchDs_Click" />
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Columns>
                                        ...
                                        <f:BoundField Width="80px" DataField="SL" ColumnID="SL" HeaderText="日均用量" TextAlign="Right" Hidden="true" />
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar2" runat="server">
                                            <Items>
                                                ...
                                                <f:ToolbarFill runat="server"></f:ToolbarFill>
                                                <f:Button EnableDefaultState="false" ID="btnSel" CssStyle="margin-left:85px;" Icon="PageBreakInsert" ConfirmText="请先选择导入的Excel文件,并确认文件已关闭?" Text="Excel导入" runat="server" OnClick="btnSelect_Click"></f:Button>
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button EnableDefaultState="false" ID="bntClr" Icon="Erase" Text="清空记录" ConfirmText="是否清空导入数据?" EnablePostBack="true" runat="server" OnClick="bntClr_Click" />
                                                <f:Button EnableDefaultState="false" ID="btnInsert" Icon="PackageStart" Text="导入系统" ConfirmText="是否确认将此数据导入系统?" ValidateForms="Formlist" EnablePostBack="true" runat="server" OnClick="btnInsert_Click" />
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button EnableDefaultState="false" ID="btnError" Icon="SystemSearch" Text="查询错误信息" EnablePostBack="true" runat="server" OnClick="btnError_Click" />
                                                <f:Button EnableDefaultState="false" ID="btnSearch" Icon="SystemSearch" Text="查询订货信息" EnablePostBack="true" runat="server" OnClick="btnSearch_Click" />
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Items>
                                        <f:Form ID="Formlist" ShowBorder="false" AutoScroll="false" BodyPadding="10px 10px 5px 10px"
                                            ...
                                            <Rows>
                                                <f:FormRow ColumnWidths="50% 25% 25%">
                                                    <Items>
                                                        <f:FileUpload runat="server" ID="fuDocument" Label="选择Excel"  EmptyText="" CssStyle="" ShowRedStar="true"></f:FileUpload>
                                                ...
                                                <f:FormRow ColumnWidths="25% 25% 25% 25%">
                                                    <Items>
                                                        <f:Label runat="server"></f:Label>
                                                        <f:DropDownList runat="server" CssStyle="margin-left:30px"  Label="供应商" ShowRedStar="true" Required="true" ID="ddlSUPID"></f:DropDownList>
                ...
                <f:Tab Title="定数信息导入" Icon="Table" Layout="Fit" runat="server">
                    <Items>
                        <f:Panel ID="Panel1" runat="server" ShowBorder="false" BodyPadding="0px" Layout="VBOX"
                            ShowHeader="false">
                            <Items>
                                <f:Panel ID="Panel4" ShowBorder="false" BodyPadding="0px" Layout="Fit" ShowHeader="False" runat="server">
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                <f:ToolbarText ID="ToolbarText2" CssStyle="" Text="操作信息：首选选择需要导入的Excel文件！" runat="server" />
                                                <f:ToolbarFill runat="server"></f:ToolbarFill>
                                                <f:Button EnableDefaultState="false" ID="btnExport" CssStyle="margin-left:85px;" Icon="PageBreakInsert" ConfirmText="请先选择导入的Excel文件,并确认文件已关闭?" Text="Excel导入" runat="server" OnClick="btnExport_Click">
                                                </f:Button>
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button EnableDefaultState="false" ID="Btnclr" Icon="Erase" Text="清空记录" ConfirmText="是否清空导入数据?" EnablePostBack="true" runat="server" OnClick="Btnclr_Click" />
                                                <f:Button EnableDefaultState="false" ID="btnINPUT" Icon="PackageStart" Text="导入系统" ConfirmText="是否确认将此数据导入系统?" ValidateForms="FmList" EnablePostBack="true" runat="server" OnClick="btnINPUT_Click" />
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button EnableDefaultState="false" ID="btnerr" Icon="SystemSearch" Text="查询错误信息" EnablePostBack="true" runat="server" OnClick="btnerr_Click" />
                                                <f:Button EnableDefaultState="false" ID="btnSearchDS" Icon="SystemSearch" Text="查询定数信息" EnablePostBack="true" runat="server" OnClick="btnSearchDS_Click" />
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                    <Items>
                                        <f:Form ID="FmList" ShowBorder="false" AutoScroll="false" BodyPadding="10px 10px 5px 10px"
                                            ...
                                            <Rows>
                                                <f:FormRow ColumnWidths="39% 18% 18% 25%">
                                                    <Items>
                                                        <f:FileUpload runat="server" ID="FileUpd" Label="选择Excel"  EmptyText="" CssStyle="" ShowRedStar="true"></f:FileUpload>
                                                        <f:CheckBox runat="server" ID="cbxDS" Label="修改定数" CssStyle="margin-left:30px" ShowRedStar="true" Checked="true"></f:CheckBox>
                                                        <f:NumberBox runat="server" ID="nbxKCXX" Enabled="false" Width="180px" LabelWidth="120px" Label="库存下限基数" MinValue="0"  DecimalPrecision="2" ShowRedStar="true" Text="1"></f:NumberBox>
                                                ...
                                                <f:FormRow ColumnWidths="39% 18% 18% 25%">
                                                    <Items>
                                                        <f:Label runat="server"></f:Label>
                                                        <f:CheckBox runat="server" ID="cbxKC" Label="修改库存上下限" LabelWidth="120px" CssStyle="margin-left:30px"  ShowRedStar="true" AutoPostBack="true" OnCheckedChanged="cbxKC_CheckedChanged"></f:CheckBox>
                                                        <f:NumberBox runat="server" ID="nbxKCSX" Enabled="false" Width="180px" LabelWidth="120px" Label="库存上限基数" MinValue="0"  DecimalPrecision="2" ShowRedStar="true" Text="2"></f:NumberBox>
