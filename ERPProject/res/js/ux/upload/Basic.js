...
Ext.define('Ext.ux.upload.Basic', {
    ...
    statusUploadingText: '正在上传1 ({0}%)',
    statusFailedText: '错误',
    statusDoneText: '完成',
    statusInvalidSizeText: '文件太大',
    statusInvalidExtensionText: '无效文件类型',
    ...
    constructor: function(owner, config)
    {
        ...
        me.actions = {
            ...
            start: Ext.create('Ext.Action', {
                text: config.uploadButtonText || '上传',
                disabled: true,
            ...
            removeUploaded: Ext.create('Ext.Action', {
                text: config.deleteUploadedText || '移除上传',
                disabled: true,
                handler: me.removeUploaded,
                scope: me
            }),
            removeAll: Ext.create('Ext.Action', {
                text: config.deleteAllText || '移除所有',
                disabled: true,
