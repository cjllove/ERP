<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConstantOptimize.aspx.cs" Inherits="ERPProject.ERPAssist.ConstantOptimize" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="PanelMain" runat="server" ShowBorder="false" BodyPadding="0px" Layout="Anchor" ShowHeader="false">
            <Items>
                ...
                <f:Grid ID="GridGoods" AnchorValue="100% -83" ShowBorder="false" ShowHeader="false" EnableColumnLines="true" EnableTextSelection="true"
