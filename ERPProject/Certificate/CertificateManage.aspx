<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertificateManage.aspx.cs" Inherits="ERPProject.Certificate.CertificateManage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" TabPosition="Right"
            ...
            <Tabs>
                <f:Tab Title="证照列表" Icon="Table" Layout="Fit" runat="server" ID="tab1">
                    <Items>
                        <f:Panel ID="Panel2" runat="server" ShowBorder="false" BodyPadding="0px" Layout="Anchor"
                            ...
                            <Items>
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -25" ShowBorder="false" ShowHeader="false" EnableCheckBoxSelect="false"
                ...
                <f:Tab Title="证照浏览" Icon="PageWord" Layout="Fit" runat="server" ID="tab2">
                    <Items>
                                ...
                                <f:Panel ID="gridPicList" runat="server" ShowBorder="false" Width="450px" BodyPadding="0" ShowHeader="false" Layout="Fit">
                                    <Items>
                                        <f:Grid ID="gridPic" ShowBorder="false" ShowHeader="false" AllowSorting="false" EnableCheckBoxSelect="false"
                                            ...
                                            DataKeyNames="LSNO,ROWNO" OnRowClick="gridPic_RowClick">
                                            <Columns>
   ...
   <%-- <script type="text/javascript" src="../res/js/jquery.FineUIPro.myDropdown.js"></script>--%>
    <%--    <script type="text/javascript">
        // 页面AJAX回发后执行的函数
        F.ready(function () {
            if (F(tab).getActiveTab() == F(tab2)) {
                tabInit(F(tab), F(tab2));
            } else {
                tabInit(F(tab), F(tab1));
            }
        });
    </script>--%>
