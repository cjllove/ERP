<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Authorization_System.aspx.cs" Inherits="ERPProject.Certificate.Authorization_System" %>
                            ...
                            <Items>
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar2" runat="server">
                                            <Items>
                                                ...
                                                <f:TriggerBox ID="tgbSearch" Width="400px" runat="server" EmptyText="按流水号和档案编号查询" TriggerIcon="Search" OnTriggerClick="btnSearch_Click" />
                                            </Items>
                                        </f:Toolbar>
                                    </Toolbars>
                                </f:Panel>
                                <f:Grid ID="GridList" AnchorValue="100% -25" ShowBorder="false" ShowHeader="false" AllowSorting="false" AutoScroll="true" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <f:BoundField Width="140px" DataField="SENDOBJ" HeaderText="授权对象" TextAlign="Center" />
                                        <f:BoundField Width="140px" DataField="SQOBJ" HeaderText="被授权对象" TextAlign="Center" />
                                        <f:BoundField Width="80px" DataField="FLAG" HeaderText="授权书状态" TextAlign="Center" />
                                        <f:BoundField Width="80px" DataField="DOCID" HeaderText="档案编号" TextAlign="Center" />
