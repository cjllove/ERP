<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsCertificate.aspx.cs" Inherits="ERPProject.Certificate.GoodsCertificate" %>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <Items>
                        <f:Panel ID="Panel2" runat="server" ShowBorder="false" BodyPadding="0px" Layout="Anchor"
                            ...
                            <Items>
                                <f:Panel ID="Panel3" ShowBorder="false" BodyPadding="0px"
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar2" runat="server">
                                            <Items>
                                                <f:ToolbarText ID="ToolbarText1" Text="商品证照查询：" runat="server"></f:ToolbarText>
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -35" ShowBorder="false" ShowHeader="false" AllowSorting="false" AutoScroll="true" runat="server"
                                     EnableCheckBoxSelect="false" AllowPaging="true" OnPageIndexChange="GridList_PageIndexChange"
                                    DataKeyNames="SEQNO" EnableRowDoubleClickEvent="true" EnableColumnLines="true" OnRowDoubleClick="GridList_RowDoubleClick" PageSize="20">
                                    <Columns>
                                        ...
                                        <f:BoundField Width="100px" DataField="GDNAME" HeaderText="商品名称" />
                                        <f:BoundField Width="100px" DataField="SUPNAME" HeaderText="供应商" ExpandUnusedSpace="true" />
                                        <f:BoundField Width="100px" DataField="LICENSENAME" HeaderText="证照类型" TextAlign="Center" />
                                        <f:BoundField Width="80px" DataField="FLAG" HeaderText="证照状态" />
        ...
        <f:HiddenField ID="hfBMPATH" runat="server" />
        <f:HiddenField ID="hfUpdate" runat="server" />
    </form>
