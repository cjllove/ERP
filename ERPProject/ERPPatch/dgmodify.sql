...
--代管基础资料管理菜单
  ...
  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
    ('9101', '代管供应商管理', '91', 'BS', null, 'FUN', 'Y', null, 'S', '/ERPEntrust/SupplierEntrust.aspx', null, 'Y', 9101, 3, null, null);
--代管库房管理菜单
  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
  ...
  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
    ('9201', '代管补货管理','92', 'BS', null, 'FUN', 'Y', null, 'S', '/ERPStorage/GoodsOrder.aspx?oper=input&dg=1', null, 'Y', 9201, 3, null, null);

  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
    ('9202', '代管补货审核','92', 'BS', null, 'FUN', 'Y', null, 'S', '/ERPStorage/GoodsOrder.aspx?oper=audit&dg=1', null, 'Y', 9202, 3, null, null);

  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
    ('9203', '代管入库管理','92', 'BS', null, 'FUN', 'Y', null, 'S', '/ERPStorage/GoodsStorage.aspx?oper=input&dg=1', null, 'Y', 9203, 3, null, null);
  
  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
    ('9204', '代管入库审核','92', 'BS', null, 'FUN', 'Y', null, 'S', '/ERPStorage/GoodsStorage.aspx?oper=audit&dg=1', null, 'Y', 9204, 3, null, null);

  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
    ('9205', '代管退货管理','92', 'BS', null, 'FUN', 'Y', null, 'S', '/ERPStorage/SalesReturn.aspx?oper=input&dg=1', null, 'Y', 9205, 3, null, null);
  
  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
    ('9206', '代管退货审核','92', 'BS', null, 'FUN', 'Y', null, 'S', '/ERPStorage/SalesReturn.aspx?oper=audit&dg=1', null, 'Y', 9206, 3, null, null);
  insert into SYS_FUNCTION
    (funcid,funcname, treeid, system, funico, funtype, isvisible, micohelp, runhow, runwhat, runpara, isfuncarea, itemsort, treelevel, ipadname, method)
  values
