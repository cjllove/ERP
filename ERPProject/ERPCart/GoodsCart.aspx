<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsCart.aspx.cs" Inherits="ERPProject.ERPCart.GoodsCart" %>
...
<body>
    ...
    <script type="text/javascript">
        function del(seq) {
            $.ajax('/ERPCart/GoodsCart.aspx?oper=del&seqno=' + seq, {
                method: 'POST',
                //data: src,
                dataType: 'json',
                complete: function () {
    ...
    <script type="text/javascript">
        ...
        function addCart() {
            ...
            //将商品保存到数据库
            var _p = parent
            $.getJSON("../ERPCart/CartShowAndDo.aspx?oper=update&gdseq=" + gdseq + "&dhs=" + dhs, function (data) {
                //if (_p.changeCartState) {
                //    _p.changeCartState();
                //}
                RefreshPage();
        ...
        function upCart(gdseq, dhs, callback, deptid) {
            //console.log(gdseq)
            //console.log(dhs)
            $.getJSON("../ERPCart/CartShowAndDo.aspx?oper=update&gdseq=" + gdseq + "&dhs=" + dhs + "&deptid=" + deptid, function (data) {
                //console.log(data)
                if (callback) {
                    callback.call(this);
                }
        ...
        function submitCart() {
            $.getJSON("../ERPCart/CartShowAndDo.aspx?oper=submit", function (data) {
                if (data != null && data != "") {
        ...
        function openBillPage(billno, custid) {
            ...
            //}
            //parent.F('regionPanel_mainRegion_mainTabStrip').addTab({ id: '5101', url: '/ERPStorage/GoodsOrder.aspx?oper=input&billno='+billno
