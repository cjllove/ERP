<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contant_GoodsWindow.aspx.cs" Inherits="ERPProject.ERPQuery.Contant_GoodsWindow" %>
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="True" BodyPadding="0px" Layout="Anchor"
            ...
            <Items>
                ...
                <f:Grid ID="GridGoods" AnchorValue="100% -30" ShowBorder="true" ShowHeader="false" EnableRowDoubleClickEvent="true" OnRowDoubleClick="GridGoods_RowDoubleClick"
                    AllowSorting="false" AutoScroll="true" runat="server" DataKeyNames="GDSEQ" EnableMultiSelect="true" EnableCheckBoxSelect="true" EnableSummary="false" SummaryPosition="Bottom"
                    PageSize="60" AllowPaging="true" OnPageIndexChange="GridGoods_PageIndexChange">
                    <Columns>
                        <f:BoundField Width="120px" DataField="GDSEQ" HeaderText="商品编码" TextAlign="Center" />
                        <f:BoundField Width="200px" DataField="GDNAME" HeaderText="商品名称" TextAlign="Center" />
                        <f:BoundField Width="0px" DataField="KCSL" HeaderText="库存数量" TextAlign="Center" />
                        <f:BoundField Width="70px" DataField="SL" HeaderText="库存可出定数" TextAlign="Center" />
                        <f:BoundField Width="0px" DataField="NUM_XS" HeaderText="定数含量" TextAlign="Center" />
                        <f:BoundField Width="0px" DataField="DSNUM" HeaderText="定数个数" TextAlign="Center" />
                        <f:BoundField Width="0px" DataField="NUM_DS" HeaderText="待收定数" TextAlign="Center" />
                        <f:BoundField Width="60px" DataField="sum_num" HeaderText="应出定数" TextAlign="Center" />
                        <f:BoundField Width="120px" DataField="GDSPEC" HeaderText="规格·容量" />
                        <f:BoundField Width="70px" DataField="UNIT" HeaderText="包装单位" />
                        <f:BoundField Width="70px" DataField="UNITNAME" HeaderText="包装单位" />
                        <f:BoundField Width="70px" DataField="BZHL" HeaderText="包装数量" Hidden="true" />
                        ...
                        <f:BoundField Width="100px" DataField="BARCODE" HeaderText="商品条码" />
