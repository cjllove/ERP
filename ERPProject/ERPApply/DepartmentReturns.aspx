<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentReturns.aspx.cs" Inherits="ERPProject.ERPApply.DepartmentReturns" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <f:PageManager ID="PageManager1" AutoSizePanelID="TabStrip1" EnableAjax="true" EnableAjaxLoading="false" OnCustomEvent="PageManager1_CustomEvent" runat="server" />
                            ...
                            <Items>
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -95" ShowBorder="false" ShowHeader="false"
                                    ...
                                    <Columns>
                                        ...
                                        <f:BoundField Width="150px" DataField="DEPTOUT" SortField="DEPTID" HeaderText="收货部门" />
                                        <f:BoundField Width="150px" DataField="DEPTID" SortField="DEPTOUT" HeaderText="申退科室" />
                                        ...
                                        <f:BoundField Width="70px" DataField="SLR" SortField="SLR" HeaderText="申退员" TextAlign="Center" />
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                ...
                                                <f:Button ID="btnSumit" Icon="UserTick" Text="提 交" EnableDefaultState="false" EnablePostBack="true" Enabled="false" runat="server" ValidateForms="FormDoc" ConfirmText="是否确认保存并提交此单据?" OnClick="btnSumit_Click" AjaxLoadingType="Mask" DisableControlBeforePostBack="true" />
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button ID="btnScan" Icon="TableConnect" Text="追溯码" Hidden="true" EnableDefaultState="false" EnablePostBack="true" runat="server" OnClick="btnScan_Click" />
                                                <f:ToolbarSeparator runat="server" />
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow>
                                                    <Items>
                                                        ...
                                                        <f:DropDownList ID="docTHTYPE" runat="server" Label="申退原因" Required="true" ShowRedStar="true" EnableEdit="false" ForceSelection="true" />
            ...
            <Items>
                <f:Grid ID="GridLot" ShowBorder="false" ShowHeader="false" AllowSorting="false" AutoScroll="true" runat="server" EnableColumnLines="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField Width="80px" DataField="KCSL" HeaderText="库存数量" TextAlign="Center"></f:BoundField>
            ...
            <Toolbars>
                <f:Toolbar ID="Toolbar5" runat="server" Position="Top" ToolbarAlign="Right">
                    <Items>
                        ...
                        <f:TextBox ID="zsmScan" runat="server" Label="扫描条码" LabelWidth="75px" Width="350px" EmptyText="扫描追溯码" ShowRedStar="true" AutoPostBack="true" OnTextChanged="zsmScan_TextChanged"></f:TextBox>
    ...
    <script type="text/javascript">
        function onGridBeforeEdit(event, value, params) {
            ...
            if (rowData.values['STR2'] && encodeURIComponent(rowData.values['STR2']).length > 9)
                return false;
            else if (F('<%= docFLAG.ClientID%>').getValue() == "M" || F('<%= docFLAG.ClientID%>').getValue() == "R")
                return true;
            else
                return false;
    }
    ...
    function btnPrint_Bill() {
        ...
        ReportViewer.ReportURL = "/grf/GoodsReturnISDG.grf?timestamp=" + new Date().getTime();
