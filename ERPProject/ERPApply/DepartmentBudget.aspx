<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentBudget.aspx.cs" Inherits="ERPProject.ERPApply.DepartmentBudget" %>
                ...
                <f:Grid ID="GridList" AnchorValue="100% -90" ShowBorder="false" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:TemplateField HeaderText="商品名称" Width="180px" ColumnID="COUNTTITLE">
                            <ItemTemplate>
                                <a href="#" onclick="javascript:addTab('<%#Eval("GDSEQ") %>|<%#Eval("DEPTID")%>','ERPapply/DepartmentSingleBudget.aspx','科室单品月度执行分析')"><%#Eval("GDNAME") %></a>
                            </ItemTemplate>
                        </f:TemplateField>
                        ...
                        <f:BoundField Width="100px" DataField="ERPSL" HeaderText="ERP消耗数量" TextAlign="Center" SortField="ERPSL" ColumnID="ERPSL" />
