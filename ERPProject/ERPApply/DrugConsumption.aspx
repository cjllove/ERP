<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DrugConsumption.aspx.cs" Inherits="ERPProject.ERPApply.DrugConsumption" %>
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        ...
                                        <f:ToolbarSeparator runat="server" />
                                        <f:Button ID="btnAudit" Icon="UserTick" Text="审 核" EnableDefaultState="false" EnablePostBack="true" ConfirmText="是否确认保存并审核此单据?" runat="server" OnClick="btnBill_Click" ValidateForms="FormDoc" Enabled="false" />
