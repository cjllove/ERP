<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptGzChange.aspx.cs" Inherits="ERPProject.ERPApply.DeptGzChange" %>
...
<body>
    ...
    <form id="form1" runat="server">
                    ...
                    <Items>
                        <f:Panel ID="Panel1" runat="server" ShowBorder="false" BodyPadding="0px" Layout="Region"
                            ...
                            <Items>
                                <f:Panel ID="Panel8" BodyPadding="0px" RegionSplit="false" EnableCollapse="false" RegionPosition="Top" ShowBorder="false"
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                <f:ToolbarText ID="ToolbarText1" CssStyle="" Text="操作信息：高值信息修改界面" runat="server" />
                                                ...
                                                <f:ToolbarSeparator runat="server" />
                                                <f:Button ID="btnDelRow" Icon="Delete" Text="删 行" EnableDefaultState="false" Enabled="false" EnablePostBack="true" ConfirmText="是否删除选中行信息?" runat="server" OnClick="btnBill_Click" />
                                                <f:ToolbarSeparator runat="server" />
                                    ...
                                    <Items>
                                        <f:Form ID="FormDoc" ShowBorder="false" AutoScroll="false" BodyPadding="10px 10px 5px 10px"
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow>
                                                    <Items>
                                                        <f:TextBox ID="tbxSTR1" runat="server" Label="调整原因" MaxLength="40" ShowRedStar="true" Required="true"></f:TextBox>
                                ...
                                <f:Grid ID="GridGoods" AnchorValue="100% -142" ShowBorder="false" ShowHeader="false" AllowColumnLocking="true"
                                    AllowSorting="false" AutoScroll="true" runat="server" CssStyle="border-top: 1px solid #99bce8;" EnableTextSelection="true"
                                    DataKeyNames="GDSEQ" AllowCellEditing="true" ClicksToEdit="1">
                                    <Columns>
                                        ...
                                        <f:RenderField Width="0px" ColumnID="UNIT" DataField="UNIT" FieldType="String" EnableHeaderMenu="false" EnableColumnHide="false" EnableLock="true" Locked="true" Hidden="true"
                                            HeaderText="包装单位编码" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="lblEditorUNIT" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="80px" ColumnID="UNITNAME" DataField="UNITNAME" FieldType="String" EnableLock="true" Locked="true"
                                            HeaderText="包装单位" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="lblEditorUNITNAME" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="90px" ColumnID="NUM1" DataField="NUM1" EnableHeaderMenu="false"
                                            HeaderText="原最低库存" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="LabNUM1" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="90px" ColumnID="NUM2" DataField="NUM2" EnableHeaderMenu="false"
                                            HeaderText="调整最低库存<font color='red'>*</font>" TextAlign="Center">
                                            <Editor>
                                                <f:NumberBox ID="NbxNUM2" runat="server" MinValue="0" Required="true" NoDecimal="true" MaxValue="99999" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="0px" ColumnID="JXTAX" DataField="JXTAX" FieldType="Float" EnableHeaderMenu="false" EnableColumnHide="false" Hidden="true"
                                            HeaderText="税率" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="lblEditorJXTAX" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="80px" ColumnID="HSJJ" DataField="HSJJ"
                                            HeaderText="含税进价" RendererFunction="round4">
                                            <Editor>
                                                <f:Label ID="lblHSJJ" runat="server"></f:Label>
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="0px" ColumnID="PRODUCER" Hidden="true" DataField="PRODUCER" FieldType="String" EnableHeaderMenu="false" EnableColumnHide="false"
                                            HeaderText="生产厂家编码" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="lblEditorPRODUCER" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="0px" ColumnID="ZPBH" DataField="ZPBH" FieldType="String" Hidden="true"
                                        ...
                                        <f:RenderField Width="0px" ColumnID="DSSL" DataField="DSSL" EnableHeaderMenu="false" Hidden="true"
                                            HeaderText="原定数数量" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="lblKCSL" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="0px" ColumnID="DSHL" DataField="DSHL" EnableHeaderMenu="false" Hidden="true"
                                            HeaderText="原定数含量" TextAlign="Center">
                                            <Editor>
                                                <f:Label ID="LabDSHL" runat="server" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="0px" ColumnID="DSSL_TZ" DataField="DSSL_TZ" EnableHeaderMenu="false" Hidden="true"
                                            HeaderText="调整定数数量" TextAlign="Center">
                                            <Editor>
                                                <f:NumberBox ID="nbxDSSL_TZ" runat="server" MinValue="0" NoDecimal="true" MaxValue="99999" />
                                            </Editor>
                                        </f:RenderField>
                                        <f:RenderField Width="0px" ColumnID="DSHL_TZ" DataField="DSHL_TZ" EnableHeaderMenu="false" Hidden="true"
                                            HeaderText="调整定数含量" TextAlign="Center">
                                            <Editor>
        ...
        <f:Window ID="WindowReject" Title="驳回信息" Hidden="true" EnableIFrame="false" runat="server"
            EnableMaximize="false" EnableResize="true" Target="Parent" IsModal="True" Layout="Fit" Width="370px" Height="210px">
            <Items>
    ...
    <script type="text/javascript">
        ...
        function btnPrint_Bill() {
            ...
            ReportViewer.ReportURL = "/grf/Mod_Gz.grf";
            var dataurl = "/captcha/PrintReport.aspx?Method=Mod_Gz&osid=" + billNo;
