<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConstantRecycle.aspx.cs" Inherits="ERPProject.ERPApply.ConstantRecycle" %>
                            ...
                            <Items>
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -95" ShowBorder="false" ShowHeader="false"
                                    ...
                                    <Columns>
                                        ...
                                        <f:BoundField Width="150px" DataField="DEPTID" SortField="DEPTID" HeaderText="回收科室" TextAlign="Center" />
                            ...
                            <Items>
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                ...
                                                <f:Button ID="btnDel" Icon="PageCancel" Text="删 除" EnablePostBack="true" ConfirmText="是否确定删除此单据?" Enabled="false" runat="server" OnClick="btnBill_Click" />
                                                ...
                                                <f:Button ID="btnDelRow" Icon="Delete" Text="删 行" EnablePostBack="true" runat="server" ConfirmText="是否确定删除选中行?" OnClick="btnBill_Click" />
                                                ...
                                                <f:Button ID="btnPrint" Icon="Printer" Text="打印单据" EnablePostBack="false" runat="server" OnClientClick="btnPrint_Bill()" />
                                                <f:Button ID="btnCopy" Icon="PageCopy" Text="复 制" ConfirmText="是否确定复制单据信息?" EnablePostBack="true" runat="server" OnClick="btnBill_Click" />
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ColumnWidths="25% 25% 25% 25%">
                                                    <Items>
                                                        ...
                                                        <f:TriggerBox runat="server" Label="test" OnTriggerClick="tbxINSERT_TextChanged"></f:TriggerBox>
                                ...
                                <f:Grid ID="GridGoods" AnchorValue="100% -123" ShowBorder="false" ShowHeader="false" EnableSummary="true" SummaryPosition="Bottom"
                                    ...
                                    <Columns>
                                        ...
                                        <f:RenderField Width="0px" ColumnID="DHSL" DataField="DHSL" FieldType="Int" EnableHeaderMenu="false" EnableColumnHide="false"
                                        ...
                                        <f:RenderField Width="70px" ColumnID="HSJJ" DataField="HSJJ" FieldType="String" EnableHeaderMenu="false"
                                            HeaderText="含税进价" TextAlign="Center" RendererFunction="renderGender4">
                                            <Editor>
                                        ...
                                        <f:RenderField Width="70px" ColumnID="HSJE" DataField="HSJE" FieldType="Float" EnableHeaderMenu="false"
                                            HeaderText="含税金额" TextAlign="Center" RendererFunction="renderGender">
                                            <Editor>
