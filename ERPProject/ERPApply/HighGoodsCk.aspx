<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HighGoodsCk.aspx.cs" Inherits="ERPProject.ERPApply.HighGoodsCk" %>
...
<body>
    ...
    <form id="form1" runat="server">
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        ...
                                        <f:Button ID="btnPrt" Icon="Printer" Text="打印拣货单" EnablePostBack="false" runat="server" OnClientClick="btn_Bill()" EnableDefaultState="false" Hidden="true" />
        ...
        <f:HiddenField ID="hfdBills" runat="server"></f:HiddenField>
    ...
    <script type="text/javascript">
        function btn_Bill() {
            ...
            var dataurl = "/captcha/PrintReport.aspx?Method=GetData_GZCKJH&osid=" + billNo;
        ...
        function btnPrint_Bill() {
            ...
            var Report = ReportViewer.Report;
            Report.OnPrintEnd = OnPrintEnd();
            ReportViewer.ReportURL = "/grf/cksldx.grf?timestamp=" + new Date().getTime();
            var dataurl = "/captcha/PrintReport.aspx?Method=GetData_GZSMCKD&osid=" + billNo;
            ReportViewer.Report.LoadDataFromURL(dataurl);
            ReportViewer.Start();
            ReportViewer.Report.PrintPreview(true);
            ReportViewer.Stop();
