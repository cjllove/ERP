<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentMonthBudgetBig.aspx.cs" Inherits="ERPProject.ERPApply.DepartmentMonthBudgetBig" %>
                ...
                sub_option: {
                    ...
                    listeners: {
                        click: function () {
                            ...
                            parent.addExampleTab.apply(null, ['hello_FineUIPro_tab', "/ERPapply/DepartmentBudget.aspx", '科室月度预算执行计划', '../../res/images/filetype/vs_aspx.png', true]);
                        }
                    }
                }
