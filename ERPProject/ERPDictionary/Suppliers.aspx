<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Suppliers.aspx.cs" Inherits="ERPProject.ERPDictionary.Suppliers" %>
                            ...
                            <Rows>
                                ...
                                <f:FormRow ColumnWidths="44% 22% 22% 12%">
                                    <Items>
                                        ...
                                        <f:CheckBox ID="chkISDG" runat="server" Label="是否代管" Checked="false" Hidden="true"></f:CheckBox>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow ColumnWidths="22% 22% 22% 22% 12%">
                                    <Items>
