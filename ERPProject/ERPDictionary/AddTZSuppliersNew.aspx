<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTZSuppliersNew.aspx.cs" Inherits="ERPProject.ERPDictionary.AddTZSuppliersNew" %>
...
<body>
    ...
    <form id="form1" runat="server">
                            ...
                            <Items>
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -70" ShowBorder="false" ShowHeader="false"
                                    ...
                                    <Columns>
                                        ...
                                        <f:BoundField Width="120px" ColumnID="FLAGNAME" DataField="FLAGNAME" HeaderText="单据状态" SortField="FLAG" TextAlign="Center" />
        ...
        <f:Window ID="WindowGoods" Title="商品信息" Hidden="true" EnableIFrame="false" runat="server" AutoScroll="true"
            EnableMaximize="false" EnableResize="true" Target="Parent" Layout="Anchor" Width="900px" Height="500">
            <Items>
                <f:Grid ID="GridSupplier" ShowBorder="false" ShowHeader="false" Height="250px"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar3" runat="server">
                            <Items>
                                <f:TriggerBox ID="tgbSearch" TriggerIcon="Search" Width="300px" EmptyText="输入供应商编码或供应商名称关键词查询" runat="server" OnTriggerClick="btnSearch_Click"></f:TriggerBox>
