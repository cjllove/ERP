<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsConfigureManage.aspx.cs" Inherits="ERPProject.ERPDictionary.GoodsConfigureManage" %>
                                    ...
                                    <Items>
                                        ...
                                        <f:Grid ID="GridCFGGoods" ShowBorder="false" ShowHeader="false" AllowSorting="true" BoxFlex="1" CssStyle="border-top: 0px solid #99bce8;border-left: 1px solid #99bce8;"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField Width="50px" DataField="IERP" HeaderText="盘点" TextAlign="Center" />
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ColumnWidths="50%   25%  13% 12%">
                                                    <Items>
                                                        ...
                                                        <f:CheckBox ID="chkIERP" runat="server" Label="是否盘点" Checked="true" LabelSeparator="" />
                                                    </Items>
                                                </f:FormRow>
                        ...
                        <f:Panel ID="Panel8" ShowBorder="false" BoxFlex="1" AnchorValue="100% -45" BodyPadding="0px"
                            ...
                            <Items>
                                <f:Grid ID="GridGoodsConfig" BoxFlex="3" ShowBorder="false" ShowHeader="false"
                                    ...
                                    EnableCheckBoxSelect="true" EnableMultiSelect="false" EnableColumnLines="true" KeepCurrentSelection="true"
                                    EnableRowDoubleClickEvent="false" EnableRowClickEvent="true" OnRowClick="GridGoodsConfig_RowDoubleClick"
