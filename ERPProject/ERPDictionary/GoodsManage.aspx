<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsManage.aspx.cs" Inherits="ERPProject.ERPDictionary.GoodsManage" %>
                                    ...
                                    <Rows>
                                        <f:FormRow>
                                            <Items>
                                                ...
                                                <f:DropDownList ID="ddlCATID" runat="server" Label="商品分类" Required="true" ShowRedStar="true" AutoPostBack="true" Enabled="true" EnableEdit="true" ForceSelection="true" OnSelectedIndexChanged="ddlCATID_SelectedIndexChanged" TabIndex="3">
                                                </f:DropDownList>
                                    ...
                                    <Rows>
                                        ...
                                        <f:FormRow ColumnWidths="22% 22% 22% 22% 12%">
                                            <Items>
                                                ...
                                                <f:CheckBox ID="ckbSTR6" runat="server" Label="计费商品" TabIndex="18" />
