<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupghFx.aspx.cs" Inherits="ERPProject.ERPQuery.SupghFx" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" TabPosition="Right"
            ...
            <Tabs>
                <f:Tab Title="供应商供货排行" Icon="Table" Layout="Fit" runat="server">
                    <Items>
                                                ...
                                                <f:FormRow>
                                                    <Items>
                                                        <f:DropDownList ID="lstSUPPLIER" runat="server" Label="供应商" EnableEdit="true" ForceSelection="true">
                                                              ...
                                                              <f:DropDownList ID="lstDEPTID" runat="server" Label="部门" EnableEdit="true" ForceSelection="true">
                                                        </f:DropDownList>
                                ...
                                <f:Grid ID="GridGoods" AnchorValue="100% -284" ShowBorder="false" ShowHeader="false" CssStyle="border-top: 1px solid #99bce8;" SummaryPosition="Bottom" EnableSummary="true"
                                    ...
                                    <Columns>
                                        ...
                                        <f:BoundField DataField="SUMKCJE" ColumnID="SUMKCJE" SortField="SUMKCJE" HeaderText="库存金额" Width="80px"></f:BoundField>
                                          <f:GroupField runat="server" HeaderText="供货数量" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="SYSL" SortField="SYSL" ColumnID="SYSL"   HeaderText="供货数量" TextAlign="Right" DataFormatString="{0:f2}" />
                                                <%--<f:BoundField Width="110px" DataField="SLZB" SortField="SLZB" ColumnID="SLZB" HeaderText="占比"  TextAlign="Center" />--%>
                                                <f:BoundField Width="110px" DataField="SLZB" SortField="SYSL" ColumnID="SLZB" HeaderText="占比"  TextAlign="Center" />
                                                ...
                                                <%--<f:BoundField Width="110px" DataField="SLHB" SortField="SLHB"  ColumnID="SLHB" HeaderText="环比增长" TextAlign="Center" />
                                                <f:BoundField Width="110px" DataField="SLTB" SortField="SLTB"  ColumnID="SLTB" HeaderText="同比增长"  TextAlign="Center" />--%>
                                                <f:BoundField Width="110px" DataField="SLHB" SortField="SLHBZ"  ColumnID="SLHB" HeaderText="环比增长" TextAlign="Center" />
                                                <f:BoundField Width="110px" DataField="SLTB" SortField="SLTBZ"  ColumnID="SLTB" HeaderText="同比增长"  TextAlign="Center" />
                                            </Columns>
                                        </f:GroupField>
                                        <f:GroupField runat="server" HeaderText="供货金额" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="80px" DataField="SYJE" SortField="SYJE" ColumnID="SYJE" HeaderText="供货金额" TextAlign="Right" DataFormatString="{0:f2}" />
                ...
                <f:Tab Title="供应商供货明细排行" Icon="Table" Layout="Fit" runat="server" >
                    <Items>
                        <f:Panel ID="Panel2" runat="server" ShowBorder="False" BodyPadding="0px" Layout="Anchor"
                            ...
                            <Items>
                                        ...
                                        <f:Toolbar ID="Toolbar2" runat="server">
                                            <Items>
                                                ...
                                                <f:Button ID="btnExpt" runat="server" CssStyle="margin-left: 10px;" Icon="DatabaseGo" EnableAjax="false" EnableDefaultState="false"
                                                    OnClick="btExport_Click" EnablePostBack="true" Text="导出" DisableControlBeforePostBack="true" />
                                                <f:ToolbarSeparator runat="server" />
                                    ...
                                    <Items>
                                        <f:Form ID="FormList" ShowBorder="false" AutoScroll="false" BodyPadding="10px 0px 10px 10px"
                                            ...
                                            <Rows>
                                                <f:FormRow>
                                                    <Items>
                                                        <f:DropDownList ID="ddlDEPTID" runat="server" Label="部门" EnableEdit="true" ForceSelection="true" Enabled="false">                                                           
                                                        </f:DropDownList>
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -82" ShowBorder="false" ShowHeader="false" CssStyle="border-top: 1px solid #99bce8;" SummaryPosition="Bottom" EnableSummary="true"
                                    AllowPaging="true" IsDatabasePaging="true" SortField="SYJE" SortDirection="DESC" PageSize="50" OnSort="GridList_Sort" OnPageIndexChange="GridGoods_PageIndexChange"
                                    AllowSorting="true" AutoScroll="true" runat="server" DataKeyNames="SUPID" EnableColumnLines="true">
                                    <Columns>
                                        ...
                                        <f:GroupField runat="server" HeaderText="数量分析" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="100px" DataField="SYSL" ColumnID="SYSL" SortField="SYSL" HeaderText="供货数量" DataFormatString="{0:f2}" TextAlign="Right" />
                                                <%--<f:BoundField Width="90px" DataField="SLZB" SortField="SLZB" ColumnID="SLZB" HeaderText="数量占比" TextAlign="Right" DataFormatString="{0:p}" />--%>
                                                <f:BoundField Width="90px" DataField="SLZB" SortField="SYSL" ColumnID="SLZB" HeaderText="数量占比" TextAlign="Right" DataFormatString="{0:p}" />
                                                <%--<f:BoundField Width="110px" DataField="SLTB" SortField="SLTB" ColumnID="SLTB" HeaderText="同比" DataFormatString="{0:p2}" TextAlign="Center" />
                                                <f:BoundField Width="110px" DataField="SLHB" SortField="SLHB" ColumnID="SLHB" HeaderText="环比" DataFormatString="{0:p2}" TextAlign="Center" />--%>
                                                <f:BoundField Width="110px" DataField="SLTB" SortField="SLTBZ" ColumnID="SLTB" HeaderText="同比" DataFormatString="{0:p2}" TextAlign="Center" />
                                                <f:BoundField Width="110px" DataField="SLHB" SortField="SLHBZ" ColumnID="SLHB" HeaderText="环比" DataFormatString="{0:p2}" TextAlign="Center" />
                                              <f:BoundField DataField="SLHBZ" ColumnID="SLHBZ" Hidden="true"></f:BoundField>
                                                <f:BoundField  DataField="SLTBZ" ColumnID="SLTBZ" Hidden="true"></f:BoundField>
                                                 </Columns>
                                        </f:GroupField>
                                        <f:GroupField runat="server" HeaderText="金额分析" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="110px" DataField="SYJE"  SortField="SYJE" ColumnID="SYJE" HeaderText="供货金额" DataFormatString="{0:f2}" TextAlign="Right" />
