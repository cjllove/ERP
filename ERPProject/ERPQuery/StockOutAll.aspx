<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockOutAll.aspx.cs" Inherits="ERPProject.ERPQuery.StockOutAll" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function btnPrint_onclick() {
            ...
            var print = getCookie("WEGOERP_PRINT_StockOutAll");
            if (print != null && print != "") {
                setCookie("WEGOERP_PRINT_StockOutAll", print);
        ...
        function PrintCKD() {
            ...
            var dataurl = "";
            //ReportViewer.ReportURL = "/ERPXM/XJ_CJRM/GRF/SHTXD_PLDY.grf?timestamp=" + new Date().getTime();
