<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeptSy.aspx.cs" Inherits="ERPProject.ERPQuery.DeptSy" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" TabPosition="Right"
            ...
            <Tabs>
                <f:Tab Title="部门损益排行" Icon="Table" Layout="Fit" runat="server">
                    <Items>
                            ...
                            <Items>
                                <f:Panel ID="PanelBody" ShowBorder="false" BodyPadding="0px"
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                <f:ToolbarText ID="ToolbarText" runat="server" Text="操作信息：商品损益分析主界面！"></f:ToolbarText>
                                ...
                                <f:Grid ID="GridGoods" AnchorValue="100% -284" ShowBorder="false" ShowHeader="false" CssStyle="border-top: 1px solid #99bce8;" SummaryPosition="Bottom" EnableSummary="true"
                                    ...
                                    <Columns>
                                        ...
                                        <f:BoundField DataField="NAME" ColumnID="NAME" SortField="NAME" HeaderText="部门" ExpandUnusedSpace="true" MinWidth="200px" />
                                        <f:GroupField runat="server" HeaderText="数量分析" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="110px" DataField="SL" SortField="SL" ColumnID="SL" HeaderText="损益数量" TextAlign="Right" DataFormatString="{0:f2}" />
                                        ...
                                        <f:GroupField runat="server" HeaderText="金额分析" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="110px" DataField="HSJE" SortField="HSJE" ColumnID="HSJE" HeaderText="损益金额" TextAlign="Right" DataFormatString="{0:f2}" />
                ...
                <f:Tab Title="部门损益明细" Icon="Table" Layout="Fit" runat="server">
                    <Items>
                            ...
                            <Items>
                                ...
                                <f:Grid ID="GridList" AnchorValue="100% -82" ShowBorder="false" ShowHeader="false" CssStyle="border-top: 1px solid #99bce8;" SummaryPosition="Bottom" EnableSummary="true"
                                    ...
                                    <Columns>
                                        ...
                                        <f:GroupField runat="server" HeaderText="数量分析" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="100px" DataField="SL" ColumnID="SL2" SortField="SL" HeaderText="损益数" DataFormatString="{0:f2}" TextAlign="Right" />
                                        ...
                                        <f:GroupField runat="server" HeaderText="金额分析" TextAlign="Center">
                                            <Columns>
                                                <f:BoundField Width="110px" DataField="HSJE" ColumnID="HSJE2" HeaderText="损益金额" DataFormatString="{0:f2}" TextAlign="Right" />
