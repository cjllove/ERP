<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoomOutQuery.aspx.cs" Inherits="ERPProject.ERPQuery.RoomOutQuery" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <f:TabStrip ID="TabStrip1" ShowBorder="false" TabPosition="Right"
            ...
            <Tabs>
                <f:Tab Title="使用汇总" Icon="Table" Layout="Fit" runat="server">
                    <Items>
                        <f:Panel ID="Panel2" runat="server" ShowBorder="false" BodyPadding="0px" Layout="Anchor"
                            ...
                            <Items>
                                            ...
                                            <Rows>
                                                <f:FormRow ColumnWidths="25% 25% 50%">
                                                    <Items>
                                                        ...
                                                        <f:TriggerBox ID="trbSearch" runat="server" Label="查询商品" EmptyText="可输入编码、名称或助记码" TriggerIcon="Search" OnTriggerClick="btnSearch1_Click"></f:TriggerBox>
                                                        <f:DropDownList ID="ddlGZ1" runat="server" Label="是否高值" EnableEdit="false" ForceSelection="true" AutoPostBack="true" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" />
                                                        <f:DropDownList ID="ddlGYS2" runat="server" Label="供应商" EnableEdit="true" ForceSelection="true" AutoPostBack="true" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" />
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
                                ...
                                <f:Grid ID="GridCom" AnchorValue="100% -80" ShowBorder="false" ShowHeader="false" CssStyle="border-top: 1px solid #99bce8;"
                                    ...
                                    EnableSummary="true" SummaryPosition="Bottom" PageSize="100" IsDatabasePaging="true" AllowPaging="true" OnPageIndexChange="GridCom_PageIndexChange" SortField="GDNAME" SortDirection="ASC" OnSort="GridCom_Sort" AllowSorting="true">
                                    <Columns>
                                        ...
                                        <f:BoundField Width="170px" DataField="SUPNAME" SortField="SUPNAME" HeaderText="供应商" TextAlign="Left" />
                                        <f:BoundField Width="80px" DataField="GZ" SortField="GZ" HeaderText="是否高值" TextAlign="Center" />
                                ...
                                <f:Panel ID="PanelBody" ShowBorder="false" BodyPadding="0px"
                                            ...
                                            <Rows>
                                                <f:FormRow>
                                                    <Items>
                                                        ...
                                                        <f:DropDownList ID="ddlDEPTID" runat="server" Label="查询科室" EnableEdit="true" ForceSelection="true" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" />
                                                        <f:DropDownList ID="ddlGYS" runat="server" Label="供应商" EnableEdit="true" ForceSelection="true" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" />
                                    ...
                                    <Items>
                                        ...
                                        <f:HiddenField ID="SELECTPRODUCERID" runat="server" />
                                                ...
                                                <f:FormRow>
                                                    <Items>
                                                        <f:DropDownList ID="ddlGZ" runat="server" Label="是否高值" EnableEdit="false" ForceSelection="true" AutoPostBack="true" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" />
