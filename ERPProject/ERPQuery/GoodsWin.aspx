<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsWin.aspx.cs" Inherits="ERPProject.ERPQuery.GoodsWin" %>
            ...
            <Items>
                <f:Form ID="FormSearch" ShowBorder="false" AutoScroll="false" BodyPadding="5px 30px 0px 30px"
                    ...
                    <Rows>
                        <f:FormRow>
                            <Items>
                                <f:TriggerBox ID="trbSearch" runat="server" Label="查询信息" EmptyText="可输入商品编码、商品名称或助记码" TriggerIcon="Search" OnTriggerClick="trbSearch_TriggerClick" />
                            </Items>
                        </f:FormRow>
                    </Rows>
                </f:Form>
