<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContantWindow_His.aspx.cs" Inherits="ERPProject.ERPQuery.ContantWindow_His" %>
        ...
        <f:Panel ID="Panel1" runat="server" ShowBorder="True" BodyPadding="0px" Layout="Anchor"
            ...
            <Items>
                ...
                <f:Grid ID="GridGoods" AnchorValue="100% -30" ShowBorder="true" ShowHeader="false" EnableRowDoubleClickEvent="true" OnRowDoubleClick="GridGoods_RowDoubleClick" EnableColumnLines="true"
                    AllowSorting="true" AutoScroll="true" runat="server" DataKeyNames="GDSEQ" EnableMultiSelect="true" EnableCheckBoxSelect="true" IsDatabasePaging="true" KeepCurrentSelection="true"
                    ...
                    <Columns>
                        ...
                        <f:BoundField Width="60px" DataField="UNITNAME" SortField="UNIT" HeaderText="单位" TextAlign="Center" EnableColumnHide="true" EnableHeaderMenu="false" />
                        <f:BoundField DataField="DSNUM" ColumnID="DSNUM" Width="80px" TextAlign="Center" HeaderText="定数数量" />
                        <f:BoundField DataField="NUM1" ColumnID="NUM1" Width="80px" TextAlign="Center" HeaderText="定数含量" />
                        <f:BoundField DataField="NUM3" ColumnID="NUM3" Width="80px" TextAlign="Center" HeaderText="待收定数" />
                        <f:BoundField DataField="ZDKC" Width="80px" TextAlign="Center" HeaderText="最低库存" />
                        <f:BoundField DataField="HSJJ" Width="110px" TextAlign="Center" HeaderText="含税进价" DataFormatString="{0:f6}" />
