<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IndexPH.aspx.cs" Inherits="ERPProject.ERPWorkbench.IndexPH" %>
            ...
            <Items>
                <f:Panel ID="Panel2" Title="左" BoxFlex="1" runat="server" ShowBorder="false" ShowHeader="false" Layout="VBox">
                    <Items>
                        ...
                        <f:Grid ID="GridConsume" BoxFlex="2" ShowBorder="false" ShowHeader="true" AutoScroll="true" runat="server"
                            DataKeyNames="GDSEQ" Title="使用情况" EnableTextSelection="true" PageSize="100" AllowPaging="true" IsDatabasePaging="true"
                            OnPageIndexChange="GridConsume_PageIndexChange">
                            <Columns>
                ...
                <f:Panel ID="Panel3" Title="右" BoxFlex="1" runat="server" ShowBorder="true" ShowHeader="false" Layout="VBox">
                    <Items>
                        <f:Panel ID="PanelDelivery" runat="server" Margin="0" BoxFlex="2"
                            BodyPadding="5px" ShowBorder="true" ShowHeader="true" Title="当日配送情况" CssStyle="overflow-x:auto">
                            <Items>
                                <f:Panel ID="Panel4" CssClass="panel-main" CssStyle="background-color: #FCFF0B;" Title="进度条" runat="server" Layout="Fit" Height="50px" EnableCollapse="true"
                                    BodyPadding="5px" ShowBorder="false" ShowHeader="false">
                                    <Items>
                                        <f:Form ID="fform" runat="server" ShowBorder="false" BodyPadding="5px" ShowHeader="false" Title="表单">
                                            <Rows>
                                                <f:FormRow>
                                                    <Items>
                                                        <f:Label ID="labelTop" CssStyle="float:right;" CssClass="label-text" Text="配送百分比！" runat="server" />
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
                                ...
                                <f:Panel runat="server" CssStyle="float:left; line-height:50px" Layout="Fit" ShowHeader="false" ShowBorder="false">
                                    <Items>
                                        <f:Form runat="server" ShowBorder="false" BodyPadding="5px" ShowHeader="false">
                                            <Rows>
                                                <f:FormRow>
                                                    <Items>
                                                        <f:Label runat="server" ID="lblMemo" CssClass="bz"></f:Label>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
                                ...
                                <f:HiddenField ID="barPercent" runat="server" Text="0"></f:HiddenField>
                                <f:HiddenField ID="hfduser" runat="server" Text="0"></f:HiddenField>
                            </Items>
                        </f:Panel>
                        <f:Grid ID="GridStockEarlyWarning" BoxFlex="4" ShowBorder="true" ShowHeader="true" Title="库存上下限预警" EnableColumnLines="true"
                        ...
                        <f:Grid ID="GridEffectiveEarlyWarning" BoxFlex="3" ShowBorder="false" ShowHeader="true" AutoScroll="true" runat="server"
                            DataKeyNames="SEQNO" Title="效期预警" EnableTextSelection="true" PageSize="100" EnableColumnLines="true">
                            <Columns>
                                <f:RowNumberField Width="35px" TextAlign="Center" EnablePagingNumber="true" />
                                <f:BoundField Width="80PX" DataField="GDSEQ" HeaderText="商品编码" TextAlign="Center" />
                                <f:BoundField Width="150PX" DataField="GDNAME" HeaderText="商品名称" />
