...
function fancyCallback(e) {
    ...
    top.$.getScript("/res/magnifyPic/source/jquery.fancybox.js", function () {
        top.$.getScript("/res/magnifyPic/source/helper/jquery.fancybox-buttons.js", function () {
	...
	$.extend(F, {
		...
		rot: function (f_w, f_h, translate) {
		    if (rad / 90 % 2) {
		        ...
		        var pianyivalue = parseInt(leftvalue);
